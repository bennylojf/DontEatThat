			...
			<table class="table table-bordered">
			   ...
			   if (!isset($_SESSION['user_username'])) { // user is not logged in 
				...
				- ($food1cholesterol/$dailycholesterol) + ($food1protein/$dailyprotein) + ($food1carbs/$dailycarbs);
					...
					$food0score = -($caloriesScale)*($food0calories/$dailycalories) - ($food0fat/$dailyfat) - ($sugarScale)*($food0sugar/$dailysugar) - ($sodiumScale)*($food0sodium/$dailysodium) 
					- ($food0cholesterol/$dailycholesterol) + ($proteinScale)*($food0protein/$dailyprotein) + ($food0carbs/$dailycarbs);
					$food1score = -($caloriesScale)*($food1calories/$dailycalories) - ($food1fat/$dailyfat) - ($sugarScale)*($food1sugar/$dailysugar) - ($sodiumScale)*($food1sodium/$dailysodium) 
					- ($food1cholesterol/$dailycholesterol) + ($proteinScale)*($food1protein/$dailyprotein) + ($food1carbs/$dailycarbs);
				}
